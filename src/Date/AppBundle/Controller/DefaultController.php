        ...
        if ($request->getMethod() == 'POST') {
            ...
            if ($form->isValid()) {
                ...
                if($date1<$date2)
                {
                    ...
                    $resultat = "La différence est de: " .$nbre_des_jours. " jours ou on a dans cette période: " .$nbre_mercredi. " mercredi sur deux et: ".$nbre_des_jours_feries. " jours fériés";
                }
                else
                    $resultat = "Erreur, Date 1 >= Date 2";


                return $this->render('DateAppBundle:Default:resultat.html.twig', array('resultat' => $resultat));
            }
        }
